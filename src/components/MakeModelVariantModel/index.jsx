        ...
        <Center>
          <Button
            ...
            onClick={() => {
              setActiveTab("make");
              if (selection.make) {
                setSelection((prev) => ({ ...prev, make: selection.make }));
              }
            }}
          >
            Make
          ...
          <Button
            ...
            onClick={() => {
              setActiveTab("model");
              if (selection.model) {
                setSelection((prev) => ({ ...prev, model:selection.model  }));
              }
            }}
          >
            Model
            ...
            <Button
              ...
              onClick={() => {
                ...
                if (selection.variant) {
                  setSelection((prev) => ({ ...prev, variant:selection.variant  }));
                }
              }}
            >
              Variants
...
export default MakeModelVariantModel;
